...
const UNI2_SWAPPER = '0xa075F8FF74941Fae5bf9Fd48736E4422474A5A66';
const ALGEBRA_SWAPPER = '0xfe5C094C5B2D51B599cE25A81595329045815b96';
...
async function main() {
  ...
  await RunHelper.runAndWait2(liquidator.populateTransaction.addBlueChipsPools(pools, true));
}
