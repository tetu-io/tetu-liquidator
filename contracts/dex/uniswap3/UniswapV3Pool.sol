...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
  ...
  function mint(
    ...
    console.log("MINT", uint(int(tickLower)), uint(int(tickUpper)), uint(amount));
    require(amount > 0);
    ...
    // for tests we simplified it
    //        IUniswapV3MintCallback(msg.sender).uniswapV3MintCallback(amount0, amount1, data);
    console.log("all0", token0, IERC20Minimal(token0).allowance(msg.sender, address(this)));
    console.log("all1", token1, IERC20Minimal(token1).allowance(msg.sender, address(this)));
