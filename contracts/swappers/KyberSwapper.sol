...
import "../interfaces/IKyberPoolMinimal.sol";
import "../interfaces/IKyberSwapCallback.sol";
import "../proxy/ControllableV3.sol";

/// @title Swap tokens via KyberSwap Elastic contracts.
/// @author a17
contract KyberSwapper is ControllableV3, ISwapper, IKyberSwapCallback {
  ...
  string public constant KYBER_SWAPPER_VERSION = "1.0.0";
  ...
  function getPrice(
    ...
    address token0 = IKyberPoolMinimal(pool).token0();
    address token1 = IKyberPoolMinimal(pool).token1();
    ...
    (uint160 sqrtPriceX96,,,) = IKyberPoolMinimal(pool).getPoolState();
